 ...
 */
public class RetornoAsyncCallWSMeusApontamentos {

    ProgressDialog progDialog;

    @SuppressLint("ValidFragment")
    public RetornoAsyncCallWSMeusApontamentos(final Context context, final ListView Lista, final ProgressDialog progDialog){

        String vUser = SaveSharedPreference.getUserName(context);
        String vSenha = SaveSharedPreference.getSenha(context);


        String webService = "LISTADOCMA";
