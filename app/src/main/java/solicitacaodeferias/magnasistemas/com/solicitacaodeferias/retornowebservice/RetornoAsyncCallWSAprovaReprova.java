...
import com.magna.sistemas.timesheetv2.activitys.ActivityGerencial;
 ...
 */
public class RetornoAsyncCallWSAprovaReprova {

    public RetornoAsyncCallWSAprovaReprova(final Context context, final String parametro, final ProgressDialog proDialog){
        ...
        AsyncCallWSAprova asyncTask = (AsyncCallWSAprova) new AsyncCallWSAprova(new AsyncCallWSAprova.AsyncRespostaAprova() {
            ...
            public void processFinish(ArrayList result) {
                ...
                if (erroApontamento == "1A") {
                    ...
                    String tituloErroCfEmitido = context.getResources().getString(R.string.dialog_titulo_erro_controle_frequencia_emitido);
                    String mensagemCfEmitido = context.getResources().getString(R.string.dialog_mensagem_erro_controle_frequencia_emitido_reprovar);
                ...
                Intent intent = new Intent(context,ActivityGerencial.class);
