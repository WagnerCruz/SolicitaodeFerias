...
public class AsyncCallWSPreencherProjeto extends AsyncTask<String, Void, ArrayList> {
    ...
    public AsyncCallWSPreencherProjeto(AsyncResposta delegate){
        this.delegate = delegate;
    }

    protected ArrayList doInBackground(String... params) {
//        displayText = PreencherCampos.chamarWebServicePreencherCampos(params[0],params[1],params[2] ,"BUSCAPROJETO");
        return displayText;
    }
